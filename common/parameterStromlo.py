...
counts_per_degree = 10.5 	# how many counts from the wheel encoder there is to a degree. 11.83 for 16" dome. 10.9 for 12" dome. 10.5 for Stromlo dome.
slitoffset = 145.    # The position, in degrees, of the slits when the home switch is activated. 68.83 for 16" dome. 92.93 for 12" dome. 145 for Stromlo dome.
