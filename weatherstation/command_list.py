...
def execute_command(the_command, m):
    ...
    the_functions = dict(clarity=m.cmd_clarity,light=m.cmd_light,rain=m.cmd_rain,tempair=m.cmd_tempair,tempsky=m.cmd_tempsky,status=m.cmd_status,safe=m.cmd_safe)
