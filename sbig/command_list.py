...
def execute_command(the_command, m):
    ...
    the_functions = dict(closeLink=m.cmd_closeLink,establishLink=m.cmd_establishLink,getCCDParams=m.cmd_getCCDParams,setTemperature=m.cmd_setTemperature,checkTemperature=m.cmd_checkTemperature,disableRegulation=m.cmd_disableRegulation,exposeAndWait=m.cmd_exposeAndWait,focusImages=m.cmd_focusImages)
